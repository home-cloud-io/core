      ...
      >
        ...
        <div className="col-12">
          <div
            ...
            title="Choose the installed App storage volume you want to upload this file to. For example, you could upload a movie file to your Jellyfin collection by choosing the 'jellyfin-media' option."
          >
            <HelpIcon />
        ...
        <div className="col-12">
          <div
            className="container"
            display="inline-block"
            title="Input the path within the selected App's storage to upload the file. For example, if you have a folder called 'movies/family/' in your Jellyfin collection you would type 'movies/family/' here."
          >
            <HelpIcon />
            <label className="form-label">&ensp;File path (optional):</label>
          </div>
          <input className="form-control" id="path" name="path" type="text" />
        </div>
        ...
        <div className="col-12">
          <div
            className="container"
            display="inline-block"
            title="You can optionally change the file's name during upload by inputing a new name here. For example, if you want the file to be called 'example.mov' simply type that here."
          >
            <HelpIcon />
            <label className="form-label">
        ...
        <div className="col-12">
          <div
            className="container"
            display="inline-block"
            title="Choose the file to upload. This can be any file you want: videos, music, photos, etc."
          >
            <HelpIcon />
            <label className="form-label">&ensp;Select a file:</label>
          </div>
          <input
            id="file"
            className="form-control"
        ...
        <SubmitButton
          text="Upload"
          loading={state.status === FileUploadStatus.UPLOADING}
        />
