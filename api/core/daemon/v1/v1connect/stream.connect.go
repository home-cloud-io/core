...
const (
	...
	DaemonStreamServiceName = "core.daemon.stream.v1.DaemonStreamService"
)
...
const (
	...
	// Communicate RPC.
	DaemonStreamServiceCommunicateProcedure = "/core.daemon.stream.v1.DaemonStreamService/Communicate"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	daemonStreamServiceServiceDescriptor           = v1.File_core_daemon_v1_stream_proto.Services().ByName("DaemonStreamService")
	daemonStreamServiceCommunicateMethodDescriptor = daemonStreamServiceServiceDescriptor.Methods().ByName("Communicate")
)

// DaemonStreamServiceClient is a client for the core.daemon.stream.v1.DaemonStreamService service.
...
// core.daemon.stream.v1.DaemonStreamService service. By default, it uses the Connect protocol with
...
// Communicate calls core.daemon.stream.v1.DaemonStreamService.Communicate.
...
// DaemonStreamServiceHandler is an implementation of the core.daemon.stream.v1.DaemonStreamService
// service.
...
func NewDaemonStreamServiceHandler(svc DaemonStreamServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/core.daemon.stream.v1.DaemonStreamService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedDaemonStreamServiceHandler) Communicate(context.Context, *connect.BidiStream[v1.DaemonMessage, v1.ServerMessage]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("core.daemon.stream.v1.DaemonStreamService.Communicate is not implemented"))
}
