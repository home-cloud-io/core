...
/**
 * @generated from message core.daemon.stream.v1.DaemonMessage
 */
export class DaemonMessage extends Message<DaemonMessage> {
  /**
   * @generated from oneof core.daemon.stream.v1.DaemonMessage.message
   */
  message: {
    /**
     * @generated from field: core.daemon.stream.v1.Heartbeat heartbeat = 1;
     */
    value: Heartbeat;
    case: "heartbeat";
  } | {
    /**
     * @generated from field: core.daemon.stream.v1.ShutdownAlert shutdown_alert = 2;
     */
    value: ShutdownAlert;
    case: "shutdownAlert";
  ...
  static readonly typeName = "core.daemon.stream.v1.DaemonMessage";
...
/**
 * @generated from message core.daemon.stream.v1.ServerMessage
 */
export class ServerMessage extends Message<ServerMessage> {
  /**
   * @generated from oneof core.daemon.stream.v1.ServerMessage.message
   */
  message: {
    /**
     * @generated from field: core.daemon.stream.v1.Heartbeat heartbeat = 1;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "core.daemon.stream.v1.ServerMessage";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "heartbeat", kind: "message", T: Heartbeat, oneof: "message" },
  ]);
...
/**
 * @generated from message core.daemon.stream.v1.Heartbeat
 */
export class Heartbeat extends Message<Heartbeat> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "core.daemon.stream.v1.Heartbeat";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
...
/**
 * @generated from message core.daemon.stream.v1.ShutdownAlert
 */
export class ShutdownAlert extends Message<ShutdownAlert> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "core.daemon.stream.v1.ShutdownAlert";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
