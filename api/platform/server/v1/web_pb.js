// @generated by protoc-gen-es v1.10.0 with parameter "target=ts,target=js"
...
export const DeviceSettings = /*@__PURE__*/ proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 2, name: "auto_update_system", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
    ...
    { no: 6, name: "auto_update_system_schedule", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 7, name: "app_stores", kind: "message", T: AppStore, repeated: true },
  ],
);
