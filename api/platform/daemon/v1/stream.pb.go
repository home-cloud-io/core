...
var file_platform_daemon_v1_stream_proto_rawDesc = []byte{
	...
	0x22, 0x81, 0x09, 0x0a, 0x0d, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x4d, 0x65, 0x73, 0x73, 0x61,
	...
	0x73, 0x74, 0x43, 0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x42, 0x09, 0x0a, 0x07, 0x6d, 0x65, 0x73,
	...
	0x72, 0x22, 0x23, 0x0a, 0x0b, 0x44, 0x61, 0x65, 0x6d, 0x6f, 0x6e, 0x45, 0x72, 0x72, 0x6f, 0x72,
	...
	0x64, 0x49, 0x6d, 0x61, 0x67, 0x65, 0x22, 0x50, 0x0a, 0x16, 0x53, 0x65, 0x74, 0x55, 0x73, 0x65,
...
var file_platform_daemon_v1_stream_proto_msgTypes = make([]protoimpl.MessageInfo, 18)
var file_platform_daemon_v1_stream_proto_goTypes = []any{
	...
	(*SetUserPasswordCommand)(nil),      // 14: platform.daemon.v1.SetUserPasswordCommand
	(*SetTimeZoneCommand)(nil),          // 15: platform.daemon.v1.SetTimeZoneCommand
	(*AddMdnsHostCommand)(nil),          // 16: platform.daemon.v1.AddMdnsHostCommand
	(*RemoveMdnsHostCommand)(nil),       // 17: platform.daemon.v1.RemoveMdnsHostCommand
	(*SystemStats)(nil),                 // 18: platform.daemon.v1.SystemStats
}
var file_platform_daemon_v1_stream_proto_depIdxs = []int32{
	...
	18, // 4: platform.daemon.v1.DaemonMessage.system_stats:type_name -> platform.daemon.v1.SystemStats
	...
	14, // 13: platform.daemon.v1.ServerMessage.set_user_password_command:type_name -> platform.daemon.v1.SetUserPasswordCommand
	15, // 14: platform.daemon.v1.ServerMessage.set_time_zone_command:type_name -> platform.daemon.v1.SetTimeZoneCommand
	16, // 15: platform.daemon.v1.ServerMessage.add_mdns_host_command:type_name -> platform.daemon.v1.AddMdnsHostCommand
	17, // 16: platform.daemon.v1.ServerMessage.remove_mdns_host_command:type_name -> platform.daemon.v1.RemoveMdnsHostCommand
	6,  // 17: platform.daemon.v1.OSUpdateDiff.error:type_name -> platform.daemon.v1.DaemonError
	6,  // 18: platform.daemon.v1.CurrentDaemonVersion.error:type_name -> platform.daemon.v1.DaemonError
	0,  // 19: platform.daemon.v1.DaemonStreamService.Communicate:input_type -> platform.daemon.v1.DaemonMessage
	1,  // 20: platform.daemon.v1.DaemonStreamService.Communicate:output_type -> platform.daemon.v1.ServerMessage
