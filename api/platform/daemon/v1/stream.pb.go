...
var file_platform_daemon_v1_stream_proto_rawDesc = []byte{
	...
	0x22, 0xe1, 0x06, 0x0a, 0x0d, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x4d, 0x65, 0x73, 0x73, 0x61,
	...
	0x72, 0x64, 0x43, 0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x42, 0x09, 0x0a, 0x07, 0x6d, 0x65, 0x73,
	...
	0x73, 0x74, 0x65, 0x64, 0x49, 0x6d, 0x61, 0x67, 0x65, 0x22, 0x50, 0x0a, 0x16, 0x53, 0x65, 0x74,
	...
	0x09, 0x52, 0x08, 0x70, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x32, 0x70, 0x0a, 0x13, 0x44,
...
var file_platform_daemon_v1_stream_proto_msgTypes = make([]protoimpl.MessageInfo, 15)
var file_platform_daemon_v1_stream_proto_goTypes = []any{
	...
	(*SystemStats)(nil),                 // 15: platform.daemon.v1.SystemStats
}
var file_platform_daemon_v1_stream_proto_depIdxs = []int32{
	...
	15, // 4: platform.daemon.v1.DaemonMessage.system_stats:type_name -> platform.daemon.v1.SystemStats
	...
	6,  // 14: platform.daemon.v1.OSUpdateDiff.error:type_name -> platform.daemon.v1.DaemonError
	6,  // 15: platform.daemon.v1.CurrentDaemonVersion.error:type_name -> platform.daemon.v1.DaemonError
	0,  // 16: platform.daemon.v1.DaemonStreamService.Communicate:input_type -> platform.daemon.v1.DaemonMessage
	1,  // 17: platform.daemon.v1.DaemonStreamService.Communicate:output_type -> platform.daemon.v1.ServerMessage
