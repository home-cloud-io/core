...
func (m *ServerMessage) validate(all bool) error {
	...
	case *ServerMessage_SetTimeZoneCommand:
		if v == nil {
			err := ServerMessageValidationError{
				field:  "Message",
				reason: "oneof value cannot be a typed-nil",
		...
		if all {
			switch v := interface{}(m.GetSetTimeZoneCommand()).(type) {
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, ServerMessageValidationError{
						field:  "SetTimeZoneCommand",
						reason: "embedded message failed validation",
						cause:  err,
					})
				}
		...
		} else if v, ok := interface{}(m.GetSetTimeZoneCommand()).(interface{ Validate() error }); ok {
			if err := v.Validate(); err != nil {
				return ServerMessageValidationError{
					field:  "SetTimeZoneCommand",
					reason: "embedded message failed validation",
...
// Validate checks the field values on SetTimeZoneCommand with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
...
// ValidateAll checks the field values on SetTimeZoneCommand with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// SetTimeZoneCommandMultiError, or nil if none found.
func (m *SetTimeZoneCommand) ValidateAll() error {
	return m.validate(true)
}

func (m *SetTimeZoneCommand) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return SetTimeZoneCommandMultiError(errors)
	}

	return nil
}

// SetTimeZoneCommandMultiError is an error wrapping multiple validation errors
// returned by SetTimeZoneCommand.ValidateAll() if the designated constraints
// aren't met.
type SetTimeZoneCommandMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m SetTimeZoneCommandMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m SetTimeZoneCommandMultiError) AllErrors() []error { return m }

// SetTimeZoneCommandValidationError is the validation error returned by
// SetTimeZoneCommand.Validate if the designated constraints aren't met.
...
// Field function returns field value.
func (e SetTimeZoneCommandValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e SetTimeZoneCommandValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e SetTimeZoneCommandValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e SetTimeZoneCommandValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e SetTimeZoneCommandValidationError) ErrorName() string {
	return "SetTimeZoneCommandValidationError"
}

// Error satisfies the builtin error interface
func (e SetTimeZoneCommandValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sSetTimeZoneCommand.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = SetTimeZoneCommandValidationError{}
